...
--   3. Reemplaza el catálogo de suplementos con tu lista curada
--   4. Carga tus hábitos por defecto
-- ============================================================
...
-- RLS deshabilitado: igual que el resto de la app (single-user, sin login).
...
-- ============================================================
-- 3 + 4. RESEED (catálogo de suplementos + hábitos)
-- ============================================================
do $$
declare uid uuid := 'c44deaea-9de2-4eb2-b552-307fac7ecfdf';
begin
  -- Si ese user_id no existe, usa el primero
  ...
  -- ---- Limpieza: borra TODO el catálogo de suplementos del usuario ----
  -- (schedules, logs y stack_items se borran en cascada)
  delete from public.supplement_stacks where user_id = uid;
  ...
  -- ---- Hábitos (borra e inserta defaults) ----
